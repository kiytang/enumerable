...
puts "Exercise 1: Select even numbers"
puts array.select{|x| x % 2 == 0}

puts "Exercise 2: Find the square of each number"
puts array.map{|x| x ** 2}

puts "Exercise 3: Determine if there is a number evenly divisible by 31" 
puts array.select{|x| x % 31 == 0}

puts "Exercise 4: Split the numbers into two sets: ones below 500 and ones above"
